...
const (
	...
	AuthService_RefreshAccessToken_FullMethodName = "/v1.auth.AuthService/RefreshAccessToken"
...
type AuthServiceClient interface {
	...
	RefreshAccessToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RefreshTokenResponse, error)
...
func (c *authServiceClient) RefreshAccessToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RefreshTokenResponse, error) {
...
type AuthServiceServer interface {
	...
	RefreshAccessToken(context.Context, *emptypb.Empty) (*RefreshTokenResponse, error)
...
func (UnimplementedAuthServiceServer) RefreshAccessToken(context.Context, *emptypb.Empty) (*RefreshTokenResponse, error) {
